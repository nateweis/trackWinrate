...
const addDeck = (req, res) => {
    db.none('INSERT INTO decks(id, name, wins, losses, color, last_update, wl_logg)VALUES(${id}, ${name}, 0, 0, ${color}, NOW(), ${wl_logg})', req.body)
...
const changeRecord = (req, res) => {
    db.none('UPDATE decks SET wins = ${wins}, losses = ${losses}, last_update = NOW(), wl_logg = ${wl_logg} WHERE id = ${id}', req.body)
